...
# meltano_kedro documentation build
...
from meltano_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "meltano_kedro"
author = "Kedro"
...
htmlhelp_basename = "meltano_kedrodoc"
...
texinfo_documents = [
    (
        ...
        author,
        "meltano_kedro",
        "Project meltano_kedro codebase.",
        "Nearest-Neighbour",
    )
]
